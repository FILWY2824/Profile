...
// 1.2.0 下调默认上限:5000 对单机 50 并发场景过大,每桶 ~40B × 5000 = 200KB
// 看起来不多但攻击者伪造 UA/IP 刷请求时会主导这块内存。2000 对合理流量绰绰有
// 余,极端情况(uniq 请求来源 > 2000)会触发 __overflow__ 共享桶,不会无限增长。
const MAX_BUCKETS = Math.max(256, Math.min(20_000, parseInt(process.env.RATE_LIMIT_MAX_BUCKETS || '2000', 10) || 2000));
